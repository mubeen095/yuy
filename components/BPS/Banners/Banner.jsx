  ...
  return (
    <div className={styles.banner}>
      <div className={styles.bannerContent}>
        <h1>TCS BPS Mock Test 2024 - Attempt Free Online Mock Test</h1>
        <p>Prepare for Placements with Skillvertex TCS BPS Mock tests, Section- Wise Tests and Mock Interviews</p>
        <ul>
          <li>5 Foundation Mock Tests for TCS BPS Part-A</li>
          <li>5 Advanced Mock Tests for TCS BPS Part-B</li>
          <li>1:1 Mock Interview - Technical & HR</li>
        </ul>
      </div>
      <div className={styles.bannerSidebar}>
        <h2>Placement Prep Elite</h2>
        <p>Includes all 50+ Aptitude Mock Tests & Practice Tests</p>
